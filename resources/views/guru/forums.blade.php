...
<div class="flex items-center justify-between mb-6">
    ...
    <div class="flex items-center gap-2 text-sm text-slate-500 bg-white border border-slate-100 rounded-xl px-4 py-2 shadow-sm">
        ...
        <span class="font-semibold text-slate-700">{{ $forums->total() }}</span> diskusi aktif
    </div>
</div>
            ...
            <div class="flex-1 min-w-0">
                <div class="flex items-start justify-between gap-3">
                    <div class="min-w-0 flex-1">
                        <a href="{{ route('guru.forums.show', $forum) }}"
                    ...
                    <div class="shrink-0 flex flex-col items-end gap-2">
                        <div class="flex items-center gap-1 text-xs text-slate-400 bg-slate-50 px-2.5 py-1 rounded-full">
                            ...
                            <span class="font-semibold text-slate-600">{{ $forum->comments_count }}</span>
                        </div>
                ...
                {{-- Preview --}}
                <p class="text-sm text-slate-500 mt-2.5 leading-relaxed line-clamp-2">{{ $forum->content }}</p>
                ...
                <div class="flex items-center gap-3 mt-3 pt-3 border-t border-slate-50">
                    ...
                    <span class="text-slate-200">·</span>
                    <form action="{{ route('guru.forums.destroy', $forum) }}" method="POST"
