...
<div class="max-w-4xl mx-auto space-y-8 pb-12">
    ...
    <div class="relative mb-12">
        {{-- Header Background --}}
        <div class="h-48 rounded-3xl bg-gradient-to-r from-purple-600 to-indigo-500 shadow-lg overflow-hidden relative group">
        ...
        <div class="absolute -bottom-12 left-8 flex items-end space-x-6">
            <div class="w-32 h-32 rounded-3xl bg-white p-2 shadow-xl relative">
            ...
            <div class="pb-4">
                ...
                <p class="text-slate-500 font-medium flex items-center gap-2">
                    ...
                    Kelas {{ $user->kelas->nama ?? '-' }} · NISN: {{ $user->nisn }}
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="space-y-6">
            <div class="glass-card rounded-3xl p-6 border border-slate-100 shadow-sm bg-white">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <p class="text-[10px] font-black text-slate-300 uppercase tracking-widest mb-1">NISN (ID)</p>
                        <p class="text-sm font-bold text-slate-700">{{ $user->nisn }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="glass-card rounded-3xl p-8 border border-slate-100 shadow-sm bg-white relative overflow-hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
                    <div>
                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Kelas Saat Ini</p>
                        <p class="text-sm font-bold text-slate-700 bg-slate-50 p-3 rounded-xl border border-slate-100">{{ $user->kelas->nama ?? '-' }}</p>
                    </div>
                    <div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                            ...
                            <p class="text-[10px] text-slate-400 mt-2 flex items-center gap-1">
                                ...
                                Alamat hanya dapat diubah melalui pengajuan ke tata usaha/admin.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-10 pt-8 border-t border-slate-100 flex justify-end">
                    <button onclick="openModal()" class="flex items-center gap-2 px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-black rounded-2xl transition shadow-lg shadow-purple-500/20 active:scale-95">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                        Edit Akun & Password
                    </button>
                </div>
            ...
            <div class="bg-white px-8 pt-8 pb-6">
                ...
                <form action="{{ route('siswa.profile.update') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email', $user->email) }}" required
                                class="w-full px-4 py-3.5 rounded-2xl border border-slate-100 bg-slate-50 focus:outline-none focus:border-purple-400 focus:ring-4 focus:ring-purple-100 transition-all font-bold text-slate-700 text-sm">
                        </div>
                        <div>
                    ...
                    <div class="pt-8 flex gap-3">
                        ...
                        <button type="submit" class="flex-[2] px-6 py-4 bg-purple-600 hover:bg-purple-700 text-white font-black rounded-2xl transition-all shadow-xl shadow-purple-500/20 active:scale-95">
                            Simpan Perubahan
                        </button>
                    </div>
                </form>
