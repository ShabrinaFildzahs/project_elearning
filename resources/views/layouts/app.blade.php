    ...
    <aside id="sidebar" class="sidebar w-64 flex-shrink-0 flex flex-col h-full text-white">
        ...
        <nav class="flex-1 p-3 mt-4 space-y-1 overflow-y-auto">
            ...
            @elseif($role == 'guru')
                ...
                <a href="/guru/quizzes"
                    class="{{ request()->is('guru/quizzes*') ? $activeClass : $inactiveClass }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            @else {{-- siswa --}}
                ...
                <a href="/siswa/assignments"
                    ...
                    <span>Tugas Form</span>
                </a>
                <a href="/siswa/quizzes"
                    class="{{ request()->is('siswa/quizzes*') ? $activeClass : $inactiveClass }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                    </svg>
