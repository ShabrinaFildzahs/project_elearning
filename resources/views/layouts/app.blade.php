...
<head>
    ...
    <style>
        ...
        .nav-active-blue svg { color: #60a5fa; }
        .nav-active-blue:hover { color: #bfdbfe; background: rgba(59,130,246,0.22); transform: translateX(2px); }
        ...
        .nav-active-emerald svg { color: #34d399; }
        .nav-active-emerald:hover { color: #a7f3d0; background: rgba(16,185,129,0.22); transform: translateX(2px); }
        ...
        .nav-active-purple svg { color: #a78bfa; }
        .nav-active-purple:hover { color: #ddd6fe; background: rgba(139,92,246,0.22); transform: translateX(2px); }

        /* ===== SVG TRANSITION ===== */
        .nav-item svg { transition: transform 0.2s ease, color 0.2s ease; flex-shrink: 0; }
...
<body class="bg-slate-50 flex h-screen overflow-hidden">
    ...
    <aside class="sidebar w-64 flex-shrink-0 flex flex-col h-full text-white">
        ...
        <nav class="flex-1 p-3 mt-4 space-y-1 overflow-y-auto">
            @if($role == 'admin')
                @php $activeClass = 'nav-item nav-active-blue'; $inactiveClass = 'nav-item'; @endphp
            ...
            @elseif($role == 'guru')
                @php $activeClass = 'nav-item nav-active-emerald'; $inactiveClass = 'nav-item'; @endphp
                ...
                <a href="/guru/assignments" class="{{ request()->is('guru/assignments*') ? $activeClass : $inactiveClass }}">
            ...
            @else {{-- siswa --}}
                @php $activeClass = 'nav-item nav-active-purple'; $inactiveClass = 'nav-item'; @endphp
                ...
                <a href="/siswa/assignments" class="{{ request()->is('siswa/assignments*') ? $activeClass : $inactiveClass }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                    <span>Tugas & Kuis</span>
                </a>
